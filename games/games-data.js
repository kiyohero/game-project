...
window.GAME_PROJECT_GAMES = [
  ...
  { name: 'どうぶつ大冒険',      icon: '🦛', category: 'action',  file: 'animal-adventure.html' },
  ...
  { name: 'パーソナルカラー診断', icon: '💄', category: 'fortune', file: 'personal-color.html' },
  { name: '誕生日占い',         icon: '🔮', category: 'fortune', file: 'birthday-fortune.html' },
  { name: '相性占い',           icon: '💕', category: 'fortune', file: 'birthday-fortune.html?compat=1' },
];
